...
public:
    ...
    explicit _CONSTEXPR11 operator bool() const SAFEINT_NOTHROW
    {
        return !!m_int;
    }

    explicit _CONSTEXPR14 operator char() const SAFEINT_CPP_THROW
    {
        char val = 0;
    ...
    explicit _CONSTEXPR14 operator signed char() const SAFEINT_CPP_THROW
    {
        signed char val = 0;
    ...
    explicit _CONSTEXPR14 operator unsigned char() const SAFEINT_CPP_THROW
    {
        unsigned char val = 0;
    ...
    explicit _CONSTEXPR14 operator short() const SAFEINT_CPP_THROW
    {
        short val = 0;
    ...
    explicit _CONSTEXPR14 operator unsigned short() const SAFEINT_CPP_THROW
    {
    ...
    explicit _CONSTEXPR14 operator int() const SAFEINT_CPP_THROW
    {
        int val = 0;
    ...
    explicit _CONSTEXPR14 operator unsigned int() const SAFEINT_CPP_THROW
    {
        unsigned int val = 0;
    ...
    explicit _CONSTEXPR14 operator long() const SAFEINT_CPP_THROW
    {
        long val = 0;
    ...
    explicit _CONSTEXPR14 operator unsigned long() const SAFEINT_CPP_THROW
    {
        unsigned long val = 0;
    ...
    explicit _CONSTEXPR14 operator long long() const SAFEINT_CPP_THROW
    {
        long long val = 0;
    ...
    explicit _CONSTEXPR14 operator unsigned long long() const SAFEINT_CPP_THROW
    {
    ...
    explicit _CONSTEXPR14 operator wchar_t() const SAFEINT_CPP_THROW
    {
        wchar_t val = 0;
    ...
    explicit _CONSTEXPR14 operator size_t() const SAFEINT_CPP_THROW
    {
        size_t val = 0;
    ...
    explicit _CONSTEXPR14 operator float() const SAFEINT_CPP_THROW
    {
        float val = 0.0;
    ...
    explicit _CONSTEXPR14 operator double() const SAFEINT_CPP_THROW
    {
        double val = 0.0;
        SafeCastHelper< double, T, GetCastMethod< double, T >::method >::template CastThrow< E >( m_int, val );
        return val;
    }
    explicit _CONSTEXPR14 operator long double() const SAFEINT_CPP_THROW
    {
        long double val = 0.0;
